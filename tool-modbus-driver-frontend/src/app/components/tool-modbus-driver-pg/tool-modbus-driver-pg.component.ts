...
@Component({
    templateUrl: './tool-modbus-driver-pg.component.html',
    styleUrls: ['./tool-modbus-driver-pg.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class ToolModbusDriverPgComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: ToolModbusDriverPgNode;
